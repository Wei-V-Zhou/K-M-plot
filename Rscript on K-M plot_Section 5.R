...
{
  mycancerstudy <- getCancerStudies(mycgds)[47, 1]
...
{
  dat = choose_clinicaldata[choose_clinicaldata$ER_STATUS_BY_IHC == "Positive" | 
                              choose_clinicaldata$PR_STATUS_BY_IHC == "Positive", ]
  dat1 = dat
...
write.csv(dat4, "JAG2_TCGA_expr_luminal.csv")
